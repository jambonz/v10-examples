# pipeline/speechmatics-rime

Pipeline voice agent using Speechmatics STT and Rime TTS over WebSocket transport. The LLM vendor and model are configurable via application variables (OpenAI or Anthropic).

Demonstrates:
- The `pipeline` verb with Speechmatics Preview STT
- Rime TTS
