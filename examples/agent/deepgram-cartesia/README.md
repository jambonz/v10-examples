# agent/deepgram-cartesia

Voice agent using Deepgram STT and Cartesia TTS over WebSocket transport. The LLM vendor and model are configurable via application variables (OpenAI, Anthropic, Google, or Bedrock).

Demonstrates:
- The `agent` verb with separate STT, LLM, and TTS configuration
