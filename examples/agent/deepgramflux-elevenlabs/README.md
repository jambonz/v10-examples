# agent/deepgramflux-elevenlabs

Voice agent using Deepgram Flux STT and ElevenLabs TTS over WebSocket transport. The LLM vendor and model are configurable via application variables (OpenAI or Anthropic).

Demonstrates:
- The `agent` verb with Deepgram Flux STT
